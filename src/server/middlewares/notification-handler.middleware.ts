...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Proposal Submission.create': {
    roles: ['admin', 'recruiter'],
    key: 'proposal_submission',
    tenantPath: [],
    userPath: [],
  },
  'Freelancer Shortlisted.update': { roles: ['admin'], key: 'freelancer_shortlisted', tenantPath: [], userPath: [] },
  'Proposal Approved.update': { roles: ['recruiter'], key: 'proposal_approved', tenantPath: [], userPath: [] },
};
