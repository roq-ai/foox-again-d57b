...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Countries', path: '/countries', entity: 'country', service: AccessServiceEnum.PROJECT, icon: FiGlobe },
    {
      name: 'Freelance Profiles',
      path: '/freelance-profiles',
      entity: 'freelance_profile',
      service: AccessServiceEnum.PROJECT,
      icon: FiUserCheck,
    },
    { name: 'Hirings', path: '/hirings', entity: 'hiring', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
