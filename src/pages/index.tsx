  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox again, your premier marketplace bridging the gap between skilled freelancers and companies offering diverse job opportunities."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox again, your premier marketplace bridging the gap between skilled freelancers and companies offering diverse job opportunities.`}
            </Text>
            <Box
